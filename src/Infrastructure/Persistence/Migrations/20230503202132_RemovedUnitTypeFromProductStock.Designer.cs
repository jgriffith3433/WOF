...
namespace WOF.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230503202132_RemovedUnitTypeFromProductStock")]
    partial class RemovedUnitTypeFromProductStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalledIngredientRecipe", b =>
                {
                    ...
                    b.HasKey("CalledIngredientId", "RecipeId");
            ...
            modelBuilder.Entity("CalledIngredientRecipe", b =>
                {
                    b.HasOne("WOF.Domain.Entities.CalledIngredient", null)
                        .WithMany()
                        .HasForeignKey("CalledIngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WOF.Domain.Entities.Recipe", null)
                        .WithMany()
